...
**metrics-webapp** is a simple web application that displays a list of currency symbols and allows users to search for a specific one, showing its details on an according route..
...
```sh
  git clone https://github.com/Matthieu96Code/metrics-webapp.git
  cd metrics-webapp
```
...
I would like to thank [Nelson Sakwa](https://www.behance.net/sakwadesignstudio) for this beatiful design and [microverse](https://www.microverse.org/) for this opportunity
